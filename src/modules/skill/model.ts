...
export namespace CourseSkillModel {
  ...
  export const CreateCourseSkill = t.Omit(CourseSkill, [
    "id",
    "createdAt",
    "updatedAt",
  ]);
  ...
  export const MaxLevelByCurriculum = t.Object({
    curriculumId: t.String(),
  });

  // response item for a single skill's max level
  export const MaxLevelSkill = t.Object({
    skillID: t.String(),
    skillName: t.String(),
    maxLevel: t.Integer(),
  });

  export const MaxLevelSkillCourseResponse = t.Array(MaxLevelSkill);
}
