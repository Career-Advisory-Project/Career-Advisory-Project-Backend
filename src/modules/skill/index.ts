...
//       where: { id: params.courseId.trim() },
//       data: { skills: { connect: { id: params.skillId.trim() } } },
//       select: { id: true, name: true, descTH: true, descENG: true, skills: { 
//         select: { id: true, name: true, descTH: true, descENG: true, tag: true, rubrics: true } } },
//     });
//     return updated;
//   })
